...
Stack.create([
  {
    ...
    is_custom: false,
    cards:[
      Card.create(front: 'puts', back: 'Prints to screen, adds a newline after each argument'),
      Card.create(front: 'print', back: 'Prints to screen'),
      Card.create(front: '+=', back: 'Shorthand operator for addition'),
      Card.create(front: 'def', back: 'Opening of defining a method'),
      Card.create(front: 'gets.chomp', back: '"gets" is a method that retrieves only strings from the keyboard with an ending "\n" character, "chomp" removes the "/n"'},
      Card.create(front: 'Integer', back: 'Integer is the basis for the two concrete classes that hold whole numbers, Bignum and Fixnum.' },
      Card.create(front: 'Object', back: 'Object is the default root of all Ruby objects. Object inherits from BasicObject which allows creating alternate object hierarchies.' },
      Card.create(front: 'to_s', back: "The .to_s is one of ruby's ways of converting variables of one type for use as another type. This one changes something into a 'string' (text characters)" },
      Card.create(front: 'DSL', back: 'Domain Specific Langauge eg. rspec' }
    ]
  }
  # {
  #   name: "jQuery",
